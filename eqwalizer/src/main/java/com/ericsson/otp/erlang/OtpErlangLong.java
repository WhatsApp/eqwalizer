...
public class OtpErlangLong extends OtpErlangObject {
  ...
  /**
   * Get this number as a long, or rather truncate all but the least significant 64 bits from the
   * 2's complement representation of this number and return them as a long.
   *
   ...
   *
   * @return the value of this number, as an int.
   * @exception OtpErlangRangeException if the value is too large to be represented as an int, or if
   ...
   * @exception OtpErlangRangeException if the value is too large to be represented as a short.
   */
   ...
   *
   * @return the value of this number, as a short.
   * @exception OtpErlangRangeException if the value is too large to be represented as a short, or
   ...
   * @exception OtpErlangRangeException if the value is too large to be represented as a char.
   */
   ...
   * @exception OtpErlangRangeException if the value is too large to be represented as a byte.
   */
