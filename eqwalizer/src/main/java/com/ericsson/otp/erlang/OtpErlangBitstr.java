...
/**
 * Provides a Java representation of Erlang bitstrs. An Erlang bitstr is an Erlang binary with a
 * length not an integral number of bytes (8-bit). Anything can be represented as a sequence of
 * bytes can be made into an Erlang bitstr.
 */
public class OtpErlangBitstr extends OtpErlangObject {
   ...
   *
   * @param bin the array of bytes from which to create the bitstr.
   */
   ...
   *
   * @param bin the array of bytes from which to create the bitstr.
   * @param pad_bits the number of unused bits in the low end of the last byte.
   */
   ...
   *
   * @param buf the stream containing the encoded bitstr.
  ...
  /**
   * Create a bitstr from an arbitrary Java Object. The object must implement java.io.Serializable
   * or java.io.Externalizable.
   *
   * @param o the object to serialize and create this bitstr from.
   */
  ...
  private static Object fromByteArray(final byte[] buf) {
    ...
    try {
      final java.io.ByteArrayInputStream bais = new java.io.ByteArrayInputStream(buf);
  ...
  /**
   * Get the number of pad bits in the last byte of the bitstr. The pad bits are zero and in the
   * little end.
   *
  ...
  /**
   * Get the java Object from the bitstr. If the bitstr contains a serialized Java object, then this
   * method will recreate the object.
   *
   * @return the java Object represented by this bitstr, or null if the bitstr does not represent a
   *     Java Object.
   */
  ...
  /**
   * Get the string representation of this bitstr object. A bitstr is printed as #Bin&lt;N&gt;,
   * where N is the number of bytes contained in the object or #bin&lt;N-M&gt; if there are M pad
   * bits.
   *
   ...
   *
   * @param o the bitstr to compare to.
