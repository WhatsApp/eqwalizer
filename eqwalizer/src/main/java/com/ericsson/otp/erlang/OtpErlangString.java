...
public class OtpErlangString extends OtpErlangObject {
   ...
   * @throws OtpErlangRangeException if an integer in the list is not a valid Unicode code point
   *     according to Erlang.
   */
   ...
   * @return true if the strings consist of the same sequence of characters, false otherwise.
   */
  @Override
   ...
   *
   * @param s a String to convert to an Unicode code point array
  ...
  /**
   * Validate a code point according to Erlang definition; Unicode 3.0. That is; valid in the range
   * U+0..U+10FFFF, but not in the range U+D800..U+DFFF (surrogat pairs).
   *
   * @param cp the code point value to validate
  ...
  /**
   * Construct a String from a Latin-1 (ISO-8859-1) encoded byte array, if Latin-1 is available,
