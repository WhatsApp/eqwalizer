...
/**
 * Provides a Java representation of Erlang atoms. Atoms can be created from strings whose length is
 * not more than {@link #maxAtomLength maxAtomLength} characters.
 */
public class OtpErlangAtom extends OtpErlangObject {
   ...
   * @exception java.lang.IllegalArgumentException if the string is null or contains more than
   ...
   *
   * @return the raw string contained in this object, without regard to Erlang quoting rules.
   * @see #toString
   */
   ...
   *
   * @return the value of this atom expressed as a boolean value. If the atom consists of the
   *     characters "true" (independent of case) the value will be true. For any other values, the
   *     value will be false.
   */
  ...
  /**
   * Get the printname of the atom represented by this object. The difference between this method
   * and {link #atomValue atomValue()} is that the printname is quoted and escaped where necessary,
