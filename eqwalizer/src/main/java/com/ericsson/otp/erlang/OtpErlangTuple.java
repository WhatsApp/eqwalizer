...
/**
 * Provides a Java representation of Erlang tuples. Tuples are created from one or more arbitrary
 * Erlang terms.
 *
 * <p>The arity of the tuple is the number of elements it contains. Elements are indexed from 0 to
 * (arity-1) and can be retrieved individually by using the appropriate index.
 */
public class OtpErlangTuple extends OtpErlangObject {
   ...
   * @exception java.lang.IllegalArgumentException if the element is null.
   */
   ...
   * @exception java.lang.IllegalArgumentException if the array is empty (null) or contains null
   *     elements.
   */
   ...
   *
   * @param i the index of the requested element. Tuple elements are numbered as array elements,
   *     starting at 0.
