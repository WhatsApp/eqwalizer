...
/**
 * Provides a Java representation of Erlang maps. Maps are created from one or more arbitrary Erlang
 * terms.
 *
 * <p>The arity of the map is the number of elements it contains. The keys and values can be
...
public class OtpErlangMap extends OtpErlangObject {
   ...
   * @exception java.lang.IllegalArgumentException if any array is empty (null) or contains null
   *     elements.
   */
   ...
   * @exception java.lang.IllegalArgumentException if any array is empty (null) or contains null
   *     elements.
   * @exception java.lang.IllegalArgumentException if kcount and vcount differ.
   */
  public OtpErlangMap(
      final OtpErlangObject[] keys,
      final int kstart,
      final int kcount,
    ...
    if (keys == null || values == null) {
      ...
      throw new java.lang.IllegalArgumentException("Map keys and values must have same arity");
    }
    map = new OtpMap();
  ...
  /**
   * Put value corresponding to key into the map. For detailed behavior description see {@link
  ...
  /**
   * Determine if two maps are equal. Maps are equal if they have the same arity and all of the
   * elements are equal.
   *
