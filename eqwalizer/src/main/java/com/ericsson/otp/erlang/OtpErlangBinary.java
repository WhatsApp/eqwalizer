...
/**
 * Provides a Java representation of Erlang binaries. Anything that can be represented as a sequence
 * of bytes can be made into an Erlang binary.
 */
public class OtpErlangBinary extends OtpErlangBitstr {
  ...
  /**
   * Create a binary from an arbitrary Java Object. The object must implement java.io.Serializable
