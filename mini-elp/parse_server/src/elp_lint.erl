...
%% Copied from https://github.com/erlang/otp/blob/1d83d4afd5c1d1128390b3535f755a1ceb0bfe2f/lib/stdlib/src/erl_lint.erl
...
ginit_fields(Ifs, Anno, Name, Dfs, Vt0, St0) ->
    ...
    IllErrs = [E || {_File,{_Anno,elp_lint,illegal_guard_expr}}=E <- Errors],
